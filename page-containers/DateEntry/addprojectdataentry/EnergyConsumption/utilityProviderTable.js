    ...
    return (
        <section className={styles.section}>
            <div className="d-flex align-items-center justify-content-between">
                ...
                <div>
                    <button type="button" className={`btn btn-outline-success ${styles.button}`} onClick={handleShow}>
                        + Add Account
                    </button>
                </div>
            </div>
            ...
            <Modal show={show} onHide={handleClose} size="lg" backdrop="static" centered>
                ...
                <Modal.Body className={styles.modalBody}>
                    <>
                        ...
                        <div className="my-4 d-flex justify-content-between">
                            <div>
                                <button type="button" className={`btn btn-outline-secondary ${styles.button}`} onClick={handleClose}> Close </button>
                            </div>
                            <div>
                                <button type="button" className={`btn btn-outline-success ${styles.button}`} onClick={handleClose}> Save Changes </button>
                            </div>
                        </div>
                    </>
                </Modal.Body>
            ...
            {/* These modals are similar to the Add modal, with different content */}
