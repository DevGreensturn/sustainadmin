...
const handleLogOut = (e) => {
  ...
  return (
    <div>
      <header style={{ padding: "10px", backgroundColor: "#f5f5f5", position: "fixed", top: "0", zIndex: "1000", width: "100%" }}>
        <div className="container-fluid">
<<<<<<< HEAD
...
>>>>>>> 0e8633ce01bafc7aa280d22aafcf37beb7ac6798
                ...
                <input
                  ...
                  placeholder="Search"
<<<<<<< HEAD
                  style={{ margin: "0px 10px", padding: "10px", borderRadius: "25px", border: "1px solid lightGrey", width: "100%" }}
                />
              </div>
            </div>
            <div className="col-auto d-flex align-items-center">
              ...
              <div className="d-flex align-items-center" style={{ cursor: "pointer" }} onClick={handleShow}>
                ...
                <div className="mx-2 d-flex align-items-center" style={{ position: "relative" }}>
    <span style={{ marginRight: "5px" }}>Moni Roy</span>
    <img src="./dropdown.png" alt="dropdown" width={10} height={10} style={{ position: "absolute", right: 0, top: "50%", transform: "translateY(-50%)" }} />
  </div>
=======
                  style={{ margin: "0px 10px", padding: "10px 150px 10px 10px", borderRadius: "25px", border: "1px solid lightGrey" }}
                />
